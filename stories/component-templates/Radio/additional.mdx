...
Form reset resets the validity and the value of the input to its initial default value.
...
Set `autofocus` on the radio group to automatically focus the checked radio. This improves keyboard navigation and accessibility in multi-step forms or when a selection triggers additional interactions.
