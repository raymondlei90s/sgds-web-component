...
For better accessibility, include a hint text to let your users know what is the range of dates that they can choose from
...
Constraint validation is implemented in datepicker as much as possible to mimic the behaviour of native HTML form component.
